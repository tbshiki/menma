...
| ID | 名前 | 目的 | 主な要件 |
| --- | --- | --- | --- |
| M0 | プロジェクト基盤 | ビルドと検証の土台を作る | NFR-01, NFR-09 |
| M1 | パーサ | Markdown を Deck モデルへ変換する | FR-01〜FR-07 |
| M2 | 発表コア | 実際の LT で最低限使える状態にする | FR-13〜FR-16, FR-18 |
| M3 | 表示品質 | 会場のプロジェクタで安定して見せられる | FR-08〜FR-11, FR-17 |
| M4 | 堅牢性と検証 | 壊れ方を設計し、CI で守る | FR-19〜FR-23, NFR-09 |
| M5 | リリース準備 | 他人が使い始められる状態にする | 受け入れ条件全項目 |
