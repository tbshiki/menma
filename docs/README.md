...
| 文書 | 何が書いてあるか |
| --- | --- |
| [writing-slides.md](./writing-slides.md) | 原稿を書く人向けのガイド。記法の使い方、つまずきどころ、AI に書かせるときの渡し方 |
...
- **記法を変えたときは `spec-markdown.md` と `writing-slides.md` の両方を直す。** 正典は `spec-markdown.md`、`writing-slides.md` はその利用者向けの言い換え
